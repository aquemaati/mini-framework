...
createComponent("todo-footer", {
    ...
    events: {
        "click@.filter-btn-all": function () {
            todos.setState(Object.assign(Object.assign({}, todos.getState()), { filter: "all" }));
            console.log(`Filter clicked: all`);
        },
        "click@.filter-btn-active": function () {
            todos.setState(Object.assign(Object.assign({}, todos.getState()), { filter: "active" }));
            console.log(`Filter clicked: active`);
        },
        "click@.filter-btn-completed": function () {
            todos.setState(Object.assign(Object.assign({}, todos.getState()), { filter: "completed" }));
        ...
        "click@.clear-completed": function () {
            ...
            todos.setState(Object.assign(Object.assign({}, todos.getState()), { todos: updatedTodos }));
        },
